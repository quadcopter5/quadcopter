	...
	public:
		...
		*/
		...
		/**
			...
			feedData() will continue where previous calls left off. As a
			corrollary, if the given buffer ends partway through a field,
			the class will maintain the partially completed field until
			the data is completed with the next call to feedData().
